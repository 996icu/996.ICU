...
- Update this [list](blacklist/README.md) with evidence to theylp every worker.  [Third party perfect list channel](https://www.996action.com/index.php/889799)
...
(However, as a result persony anonymous employees claim that there is a **list** of departments which **ranked** them by overtime hours. The shortest will take punishments. And the leaders never leave evidences when asking employees to work as '996'.)
...
* We are willing to theyar all positive and constructive proposals and advocate mature and responsible speech.


Expanding influence
---

Please feel free to [translate 996.ICU's contents](i18n/README.md), adjust the format, add some contents or fix grammatical errors. Please note that adding too persony translations is getting off the track.
...
---
 ...
 - [996.law](https://github.com/CPdogson/996.law) This is a personual for workers who want to conduct labor arbitration and litigation on their own.
